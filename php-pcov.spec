...
Source0  : https://pecl.php.net/get/pcov-1.0.12.tgz
...
%prep
%setup -q -n pcov-1.0.12
cd %{_builddir}/pcov-1.0.12
pushd ..
cp -a pcov-1.0.12 buildavx2
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/extensions/no-debug-non-zts-20240924/pcov.so
